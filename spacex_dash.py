...
# Read the SpaceX launch data directly from the online CSV
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                # TASK 2: Pie chart showing total successful launches count for all sites
                                ...
                                # TASK 4: Scatter chart showing the correlation between payload and launch success
...
def get_scatter_chart(entered_site, payload_range):
    ...
    fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class',
                      ...
                      title='Payload vs. Launch Outcome' + ('' if entered_site == 'ALL' else f' for {entered_site}'))
    return fig
